...
short_title: Risk Identification
---

Cybersecurity risk identification and analysis address three fundamental questions:

1. What could go wrong?  
2. How likely is it to happen?  
3. What would be the consequences?

In some cases, identifying and analysing risks is relatively straightforward. For example, it is easy to anticipate that AI-generated software used in drone surveillance or autonomous strike systems may introduce significant vulnerabilities.

In other situations, however, identifying potential misuse and associated harm is more challenging. Risk identification is an ongoing process that often requires specialised domain knowledge. 

Effective cybersecurity risk analysis depends on both deep and broad understanding of how weaknesses in hardware and software can create vulnerabilities, combined with relevant domain knowledge.
...
However, impact is another probabilistic value with varying results. Consider the behavior of some cybersecurity impacts:
...
When impact is a simple value-at-rest, like a bank account... it can simply be represented by that value. When impact behaves probabilistically, we can resort to writing code as a monte carlo simulation.
