...
:::{attention}
Transparency and openness increase security protection levels.
:::
However there is still a lot of resistance against using open source for business use, especially when it comes down to security and privacy functionality.
