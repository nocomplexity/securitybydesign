...
6. **Create a security architecture** – Create layered, verifiable system architectures that enforce security policies and isolate trust boundaries by design.
...
:::{warning} It is not an introduction to basic cyber security.
 If you are unfamiliar with fundamental cyber security concepts, you should first consult an [introductory resource](https://nocomplexity.com/documents/securityarchitecture/learning/cybercourses.html#security-courses). Likewise, if you are seeking in-depth, specialised knowledge in areas such as cryptography, networking, or application security, please refer to the section [Security Training](training/training_intro.md) for open and free recommended courses.
:::
